...
def main():
    st.set_page_config(page_title="Dietitian Assistant", layout="centered")
    st.title("Dietitian Assistant 🤖")
    ...
    user_question = st.text_input("Ask a question related to diet or nutrition:", key="input_box")
